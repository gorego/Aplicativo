...
namespace Aplicativo
{
    public partial class frmEstudio : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (!PDF.Equals(""))
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Vias\\" + this.Text + "\\Croquis");
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Vias\\" + this.Text + "\\Croquis", "CroquisPDF*");
                if (prueba.Length > 0)
                {
                ...
                using (FileStream fs = File.Open(PDF, FileMode.Open))
                {
                    ...
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Vias\\" + this.Text + "\\Croquis" + "\\CroquisPDF" + ext));
                }
            }
            ...
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Vias\\" + this.Text + "\\Croquis");
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Vias\\" + this.Text + "\\Croquis", "CroquisSHP*");
                if (prueba.Length > 0)
                {
                    if (File.Exists(prueba[0]))
                    {
                ...
                using (FileStream fs = File.Open(SHP, FileMode.Open))
                {
                    ...
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Vias\\" + this.Text + "\\Croquis" + "\\CroquisSHP" + ext));
                }
            }
            string KMZ = textBox3.Text;
            if (!KMZ.Equals(""))
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Vias\\" + this.Text + "\\KMZ");
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Vias\\" + this.Text + "\\KMZ", "KMZ*");
                if (prueba.Length > 0)
                {
                    if (File.Exists(prueba[0]))
                    {
                ...
                using (FileStream fs = File.Open(KMZ, FileMode.Open))
                {
                    ...
                    string ext = Path.GetExtension(SHP);
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Vias\\" + this.Text + "\\KMZ" + "\\KMZ" + ext));
                }
            }
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            if (!Registro.Equals(""))
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Lotes\\" + this.Text + "\\Registro");
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Lotes\\" + this.Text + "\\Registro", "Registro*");
                if (prueba.Length > 0)
                {
                    if (File.Exists(prueba[0]))
                    {
                ...
                using (FileStream fs = File.Open(Registro, FileMode.Open))
                {
                    ...
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Lotes\\" + this.Text + "\\Registro" + "\\Registro" + ext));
                }
            }
