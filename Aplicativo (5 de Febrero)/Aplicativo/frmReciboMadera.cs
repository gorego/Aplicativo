...
namespace Aplicativo
{
    public partial class frmReciboMadera : Form
    {
        ...
        public void agregarRecibo()
        {
            conn.ConnectionString = connectionString;
            OleDbCommand cmd;
            cmd = new OleDbCommand("INSERT INTO Recibo (Orden,Clasificacion,Motivo,Especie,volumenIngreso,volumenActual,Diametro,Largo,Cantidad,Lote,Ano,Area,Registro,Propietario,Proveedor,Conductor,Placa,Cliente,FSC,Fecha,Hora,Maquinaria,Modulo) VALUES (@Orden,@Clasificacion,@Motivo,@Especie,@volumenIngreso,@volumenActual,@Diametro,@Largo,@Cantidad,@Lote,@Ano,@Area,@Registro,@Propietario,@Proveedor,@Conductor,@Placa,@Cliente,@FSC,@Fecha,@Hora,@Maquinaria,@Modulo)");
            cmd.Connection = conn;
            conn.Open();
