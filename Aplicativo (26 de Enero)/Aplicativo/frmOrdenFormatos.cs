...
namespace Aplicativo
{
    public partial class frmOrdenFormatos : Form
    {
        ...
        string area, actividad, unidad, supervisor, estado, lote, predio, OT, fechaInicial, fechaFinal, descripcion, especie, estadoFSC, FSC, userName;
        ...
        {            
            ...
            OT = orden;
            this.Text = "Formatos de la Orden #" + orden;
            hideFormatos();
            getFormatos(orden);
            getOrden(orden);
            getLote(codigo);
            ...
            if (sw2)
            {
                ...
                for (int i = 0; i < tabControl1.TabPages.Count; i++)
                {
                    ...
                    else if (tabControl1.TabPages[i].Text.Equals("ADF012"))
                    {
                        ...
                        cargar(comboBox2, "SELECT ID, (Tipo + ' / ' + Marca + ' / ' + Placa) As Maquina FROM Maquinarias", "Maquina");
                    ...
                    {
                        cargar(comboBox3, "SELECT ID, (Tipo + ' / ' + Marca + ' / ' + Placa) As Maquina FROM Maquinarias", "Maquina");
