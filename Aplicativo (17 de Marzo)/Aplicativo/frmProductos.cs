    ...
    public partial class frmProductos : Form
    {
        ...
        public void agregarProducto()
        {
            ...
            if (conn.State == ConnectionState.Open)
            {
                ...
                {
                    Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Productos\\" + txtCodigo.Text);
                    string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Productos\\" + txtCodigo.Text, "Descripcion*");
                    if (prueba.Length > 0)
                    {
                    ...
                    using (FileStream fs = File.Open(descripcion, FileMode.Open))
                    {
                        ...
                        fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Productos\\" + txtCodigo.Text + "\\Descripcion" + ext));
                    }
                }
        ...
        {
            Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Productos\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString());
            string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Productos\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString(), "Descripcion*");
            if (prueba.Length > 0)
            {
                if (File.Exists(prueba[0]))
                {
