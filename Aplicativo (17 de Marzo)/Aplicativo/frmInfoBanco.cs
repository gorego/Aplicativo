    ...
    public partial class frmInfoBanco : Form
    {
        ...
        public void agregarPredial() {
            ...
            if (conn.State == ConnectionState.Open)
            {
                ...
                if (!predial.Equals(""))
                {
                    Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Predial\\" + txtAno.Text);
                    string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Predial\\" + txtAno.Text, "Impuesto*");
                    if (prueba.Length > 0)
                    {
                    ...
                    using (FileStream fs = File.Open(predial, FileMode.Open))
                    {
                        ...
                        fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Predial\\" + txtAno.Text + "\\Impuesto" + txtAno.Text + ext));
                    }
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                if (conn.State == ConnectionState.Open)
                {
                    try
                    {
                        ...
                        if (File.Exists("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Predial\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString() + "\\Impuesto" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString()))
                        {
                            File.Delete("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios" + this.Text + "\\Predial\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString() + "\\Impuesto" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString());
                        }
                        conn.Close();
                    }
                    catch (OleDbException ex)
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (!PDF.Equals(""))
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Croquis");
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Croquis", "CroquisPDF*");
                if (prueba.Length > 0)
                {
                    if (File.Exists(prueba[0]))
                    {
                ...
                using (FileStream fs = File.Open(PDF, FileMode.Open))
                {
                    ...
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Croquis" + "\\CroquisPDF" + ext));
                }
            }
            ...
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Croquis");
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Croquis", "CroquisSHP*");
                if (prueba.Length > 0)
                {
                    if (File.Exists(prueba[0]))
                    {
                ...
                using (FileStream fs = File.Open(SHP, FileMode.Open))
                {
                    ...
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Croquis" + "\\CroquisSHP" + ext));
                }
            }
            string KMZ = textBox4.Text;
            if (!KMZ.Equals(""))
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\KMZ");
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\KMZ", "KMZ*");
                if (prueba.Length > 0)
                {
                    if (File.Exists(prueba[0]))
                    {
                ...
                using (FileStream fs = File.Open(KMZ, FileMode.Open))
                {
                    ...
                    string ext = Path.GetExtension(SHP);
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\KMZ" + "\\KMZ" + ext));
                }
            }
            string escritura = txtEscritura.Text;
            if (!escritura.Equals(""))
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Escritura");
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Escritura", "EscrituraPublica*");
                if (prueba.Length > 0)
                {
                    if (File.Exists(prueba[0]))
                    {
                ...
                using (FileStream fs = File.Open(escritura, FileMode.Open))
                {
                    ...
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Escritura" + "\\EscrituraPublica" + ext));
                }
            }
            string certificado = textBox3.Text;
            if (!escritura.Equals(""))
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Certificado");
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Certificado", "CertificadoDeTradicionYLibertad*");
                if (prueba.Length > 0)
                {
                    if (File.Exists(prueba[0]))
                    {
                ...
                using (FileStream fs = File.Open(escritura, FileMode.Open))
                {
                    ...
                    string ext = Path.GetExtension(escritura);
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Certificado" + "\\CertificadoDeTradicionYLibertad" + ext));
                }
            }
        }
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            //if (File.Exists("C:\\Users\\" + Environment.UserName + "\\Dropbox\\" + this.Text + "\\croquis" + "\\croquisPDF"))
            //{
            //    System.Diagnostics.Process.Start("C:\\Users\\" + Environment.UserName + "\\Dropbox\\" + this.Text + "\\croquis" + "\\croquisPDF");
            //}
            //else
            //{
            //    MessageBox.Show("No se encuentra el archivo.", "Error");
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            //if (File.Exists("C:\\Users\\" + Environment.UserName + "\\Dropbox\\" + this.Text + "\\croquis" + "\\croquisSHP"))
            //{
            //    System.Diagnostics.Process.Start("C:\\Users\\" + Environment.UserName + "\\Dropbox\\" + this.Text + "\\croquis" + "\\croquisSHP");
            //}
            //else
            //{
            //    MessageBox.Show("No se encuentra el archivo.", "Error");
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            //if (File.Exists("C:\\Users\\" + Environment.UserName + "\\Dropbox\\" + this.Text + "\\escritura" + "\\NumeroDeEscrituraPublica"))
            //{
            //    System.Diagnostics.Process.Start("C:\\Users\\" + Environment.UserName + "\\Dropbox\\" + this.Text + "\\escritura" + "\\NumeroDeEscrituraPublica");
            //}
            //else
            //{
            //    MessageBox.Show("No se encuentra el archivo.", "Error");
        ...
        {
            Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Predial\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString());
            string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Predial\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString(), "Impuesto*");            
            if (prueba.Length > 0)
            {
                if (File.Exists(prueba[0]))
                {                    
            ...
            //if (File.Exists("C:\\Users\\" + Environment.UserName + "\\Dropbox\\" + this.Text + "\\predial\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString() + "\\Impuesto" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString()))
            //{
            //    System.Diagnostics.Process.Start("C:\\Users\\" + Environment.UserName + "\\Dropbox\\" + this.Text + "\\predial\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString() + "\\Impuesto" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString());
            //}
            //else
            //{
            //    MessageBox.Show("No se encuentra el archivo.", "Error");
        ...
        {
            Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Certificado");
            string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Predios\\" + this.Text + "\\Certificado", "Certificado*");
            if (prueba.Length > 0)
            {
                if (File.Exists(prueba[0]))
                {
