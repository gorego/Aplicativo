    ...
    public partial class frmLiquidacion : Form
    {
        ...
        public void agregarLiquidacion()
        {
            ...
            if (conn.State == ConnectionState.Open)
            {
                ...
                {
                    Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Empleados\\" + this.Text + "\\Liquidacion\\" + textBox1.Text);
                    string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Empleados\\" + this.Text + "\\Liquidacion\\" + textBox1.Text, "Liquidacion*");
                    if (prueba.Length > 0)
                    {
                    ...
                    using (FileStream fs = File.Open(liquidacion, FileMode.Open))
                    {
                        ...
                        fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Empleados\\" + this.Text + "\\Liquidacion\\" + textBox1.Text + "\\Liquidacion" + textBox1.Text + ext));
                    }
        ...
        {
            Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Empleados\\" + this.Text + "\\Liquidacion\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString());
            string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Empleados\\" + this.Text + "\\Liquidacion\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString(), "Liquidacion*");
            if (prueba.Length > 0)
            {
                if (File.Exists(prueba[0]))
                {
