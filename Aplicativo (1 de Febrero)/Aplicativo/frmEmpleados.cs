...
namespace Aplicativo
{
    public partial class frmEmpleados : Form
    {
        ...
        public void subirArchivo(TextBox text)
        {
            ...
            if (!arch.Equals(""))
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Empleados\\" + txtNombre.Text + " " + txtApellido.Text);
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Empleados\\" + txtNombre.Text + " " + txtApellido.Text, txtNombre.Text + " " + txtApellido.Text + "*");
                if (prueba.Length > 0)
                {
                ...
                using (FileStream fs = File.Open(arch, FileMode.Open))
                {
                    ...
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Empleados\\" + txtNombre.Text + " " + txtApellido.Text + "\\" + txtNombre.Text + " " + txtApellido.Text + ext));
                }
            }
        }
