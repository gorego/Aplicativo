...
namespace Aplicativo
{
    public partial class frmInfoCuchilla : Form
    {
        ...
        public frmInfoCuchilla(string id)
        {
            ...
            Variables.cargar(dataGridView2, "SELECT ID,Evento,Fecha FROM cuchillaEvento WHERE Cuchilla = " + id);
        ...
        public void generarEvento(string evento)
        {
            ...
            OleDbCommand cmd = new OleDbCommand();
                cmd = new OleDbCommand("INSERT INTO cuchillaEvento (Cuchilla,Evento,Fecha) VALUES (@Cuchilla,@Evento,@Fecha)");
            cmd.Connection = conn;
            conn.Open();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Variables.cargar(dataGridView2, "SELECT ID,Evento,Fecha FROM cuchillaEvento WHERE Cuchilla = " + cuchilla);
            dataGridView2.Columns[1].HeaderText = "Afilado/Triscado";
        }
