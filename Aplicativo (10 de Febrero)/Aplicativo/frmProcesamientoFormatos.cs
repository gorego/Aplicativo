...
namespace Aplicativo
{
    public partial class frmProcesamientoFormatos : Form
    {
        ...
        public frmProcesamientoFormatos(int op, int dia, int tipo)
        {
            ...
            label104.Text = "Día #: " + (dia+1);
            cargarEmpleados(op);
            orden = op;
            formatoADF020(dataGridView28, ADF020);
            formatoADF020(dataGridView1, ADF020);
            formatoADF020(dataGridView2, ADF0201);
            cargarADF006(dataGridView9, dataGridView7, dataGridView8);
            cargarADF006(dataGridView4, dataGridView6, dataGridView5);
            cargarADF006(dataGridView12, dataGridView10, dataGridView11);
        ...
        {
            string query = "SELECT ID,volumenActual,Motivo,Diametro,Largo,Cantidad,Modulo FROM Recibo WHERE Especie = '" + especie + "'";
            ...
            try
            {
                while (myReader.Read())
                {
                    ...
                    data.Rows[i].Cells[3].Value = myReader.GetInt32(0);
                    data.Rows[i].Cells[4].Value = myReader.GetDouble(1);
                    data.Rows[i].Cells[5].Value = "100%";
                    data.Rows[i].Cells[6].Value = myReader.GetDouble(1);
                    i++;
                }
            }
            finally
        ...
        public void cargarADF006(DataGridView data1, DataGridView data2, DataGridView data3)
        {
            crearADF006(data1, "SELECT * FROM Insumos WHERE Descripcion LIKE '%", "Modelo", ADF006);
        ...
        public void cargarDetalleADF006(string query, string display, DataGridView data, string[,] formato)
        {
            ...
            conn.ConnectionString = connectionString;
            string query2 = "SELECT ID, (Tipo + ' / ' + Marca + ' / ' + Placa) As Maquina FROM Maquinarias";
        ...
        private void dataGridView13_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                if (dataGridView13.CurrentCell.ColumnIndex == 5)
                {
                    if (dataGridView13.Rows[dataGridView13.CurrentCell.RowIndex].Cells[dataGridView13.CurrentCell.ColumnIndex].Value.ToString().Equals("100%"))
                        dataGridView13.Rows[dataGridView13.CurrentCell.RowIndex].Cells[6].Value = double.Parse(dataGridView13.Rows[dataGridView13.CurrentCell.RowIndex].Cells[4].Value.ToString()) * 1;
                        ...
                        dataGridView13.Rows[dataGridView13.CurrentCell.RowIndex].Cells[6].Value = double.Parse(dataGridView13.Rows[dataGridView13.CurrentCell.RowIndex].Cells[4].Value.ToString()) * 0.75;
                        ...
                        dataGridView13.Rows[dataGridView13.CurrentCell.RowIndex].Cells[6].Value = double.Parse(dataGridView13.Rows[dataGridView13.CurrentCell.RowIndex].Cells[4].Value.ToString()) * 0.5;
                        ...
                        dataGridView13.Rows[dataGridView13.CurrentCell.RowIndex].Cells[6].Value = double.Parse(dataGridView13.Rows[dataGridView13.CurrentCell.RowIndex].Cells[4].Value.ToString()) * 0.25;
                    else
                        dataGridView13.Rows[dataGridView13.CurrentCell.RowIndex].Cells[6].Value = double.Parse(dataGridView13.Rows[dataGridView13.CurrentCell.RowIndex].Cells[4].Value.ToString()) * 0;
                }
            }
        }
        ...
        {
            frmRegistrarPaquete newFrm = new frmRegistrarPaquete(orden);
            newFrm.Show();
        }
