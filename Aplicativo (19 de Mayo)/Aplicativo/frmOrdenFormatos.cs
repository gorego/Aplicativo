...
namespace Aplicativo
{
    public partial class frmOrdenFormatos : Form
    {
            ...
            if (sw2)
            {
                ...
                for (int i = 0; i < tabControl1.TabPages.Count; i++)
                {
                    ...
                    else if (tabControl1.TabPages[i].Text.Equals("ADF012"))
                    {
                        ...
                        string especie2 = especie;
                        if (especie2.Equals("Gmelina arborea"))
                            especie2 = "Melina";
                        else if (especie2.Equals("Tectona grandis"))
                            especie2 = "Teca";
                        if (especie2.Equals("Melina"))
                            radioButton4.Checked = true;
                        else if (especie2.Equals("Teca"))
                            radioButton3.Checked = true;
                        else
                        {
                            radioButton31.Checked = true;
                            textBox2.Text = especie2;
                        }
                    }
                    ...
                    {
                        Variables.cargar2(comboBox15, "SELECT Clase From Insumos GROUP BY Clase", "Clase");
                        Variables.cargar2(comboBox14, "SELECT Marca From Insumos GROUP BY Marca", "Marca");
                        Variables.cargar(comboBox13, "SELECT * From Insumos", "Modelo");
                        crearADF19(dataGridView27, "SELECT ID, (Clase + ' ' + Marca + ' ' + Modelo) As Insumo FROM Insumos", "Insumo");
                        cargarADF19(orden, "ADF019", dataGridView27);
                        termino2 = 1;
                    }
                }
            }
                ...
                if (data.Rows[i].Cells[1].Value != null)
                {
                    ...
                    try
                    {
                        while (myReader.Read())
                        {
                            ...
                            data.Rows[i].Cells[3].Value = myReader.GetDouble(7);
                        }
                    }
                    finally
                    {
        ...
        public void crearADF19(DataGridView data, string query, string display)
        {
            DataGridViewComboBoxColumn combo = new DataGridViewComboBoxColumn();
            combo.HeaderText = "Modelo";
            data.Columns.Add("Column1", "#");
            ...
            cargarDetalle(combo, query, display, data);
            data.Columns.Add(combo);
            data.Columns.Add("Column4", "Valor Unitario");
            data.Columns[4].DefaultCellStyle.Format = "c";
            data.Columns[4].ReadOnly = true;
            data.Columns.Add("Column5", "Cantidad");
            data.Columns.Add("Column20", "Total");
            data.Columns[6].DefaultCellStyle.Format = "c";
        ...
        public double getCostoJornalPasado(int semana, string orden)
        {
            double costo = 0;
            ...
            try
            {
                if (myReader.Read())
                {
                    costo = double.Parse(myReader.GetValue(0).ToString());
                }
            }
            finally
            {
        ...
        {
            double costo = getCostoJornalPasado(semana, orden);
            conn.ConnectionString = connectionString;
        ...
        {
            volumen = Math.Round(volumen, 4, MidpointRounding.AwayFromZero);
            conn.ConnectionString = connectionString;
            OleDbCommand cmd;
        ...
        public void modificarADF019(string orden, string adf, DataGridView data)
        {
            for (int i = 0; i < data.Rows.Count; i++)
            {
                conn.ConnectionString = connectionString;
                ...
                if (data.Rows[i].Cells[3].Value != null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            cmd = new OleDbCommand("UPDATE Control SET Detalle=@Detalle,Modelo=@Modelo,Lunes=@Lunes,Martes=@Martes,Miercoles=@Miercoles,Jueves=@Jueves,Viernes=@Viernes,Sabado=@Sabado WHERE Modelo = " + data.Rows[i].Cells[3].Value.ToString() + " AND ADF = '" + adf + "'");
                            k = 2;
                        }
                    }
                    j = 0;
                ...
                if (conn.State == ConnectionState.Open)
                {
                    if (k == 1)
                    {
                        cmd.Parameters.Add("@Semana", OleDbType.VarChar).Value = 0;
                        cmd.Parameters.Add("@Unidad", OleDbType.VarChar).Value = data.Rows[i].Cells[4].Value.ToString();
                        cmd.Parameters.Add("@Orden", OleDbType.VarChar).Value = orden;
                    }
                    if (data.Rows[i].Cells[2].Value != null)
        ...
        {
            string query = "SELECT Costo_Unitario FROM Insumos WHERE ID = " + id;
            //Ejecutar el query y llenar el GridView.
            conn.ConnectionString = connectionString;
            OleDbCommand cmd = new OleDbCommand(query, conn);
            cmd.Connection = conn;
        ...
        public double getSalarioDiario(int id)
        {
        ...
        public bool ADF19Existe(string orden, string adf)
        {
            string query = "SELECT * FROM Control WHERE Orden = " + orden + " AND adf = '" + adf + "'";
            //Ejecutar el query y llenar el GridView.
            conn.ConnectionString = connectionString;
            OleDbCommand cmd = new OleDbCommand(query, conn);
            cmd.Connection = conn;
            ...
            try
            {
                while (myReader.Read())
                {
                    for (int j = 6, k = 0; j < 12; j++, k++)
                        for (int i = 0; i < myReader.GetDouble(j); i++)
        ...
        public void cargarADF19(string orden, string adf, DataGridView data)
        {
            string query = "SELECT * FROM Control WHERE Orden = " + orden + " AND ADF = '" + adf + "'";
            //Ejecutar el query y llenar el GridView.
            conn.ConnectionString = connectionString;
            ...
            try
            {
                while (myReader.Read())
                {
                    ...
                    data.Rows[i].Cells[0].Value = i + 1;
                    data.Rows[i].Cells[2].Value = myReader.GetString(5);
                    data.Rows[i].Cells[5].Value = myReader.GetDouble(6).ToString();
                    i++;
                    cant19++;
                }
            }
        ...
        public void cargarSemilla(int semana, string orden, DataGridView data)
        {
            ...
            try
            {
                while (myReader.Read())
                {
                    ...
                    {
                        data.Rows[semillas].Cells[k].Value = myReader.GetDouble(j).ToString();
                    }
                    semillas++;
                }
            }
        ...
        public void crearADF19(string orden, string adf, DataGridView data)
        {
            for (int i = 0; i < data.Rows.Count; i++)
            {
                conn.ConnectionString = connectionString;
        ...
        public void formato2(DataGridView data, int inicio)
        {
            for (int i = 0; i < 300; i++)
            {
                data.Rows.Add();
        ...
        public void getOrden(string orden)
        {
            ...
            try
            {
                if (myReader.Read())
                {
                    area = myReader.GetDouble(0).ToString();
                    estado = myReader.GetString(1);
                    supervisor = myReader.GetString(2);
                    predio = myReader.GetString(3);
                    lote = myReader.GetString(4);
        ...
        public void formatoTipo1(Microsoft.Office.Interop.Excel.Application XcelApp, int semana)
        {
            ...
            XcelApp.Cells[13, 2] = codigo + " - " +lote;
        ...
        public void formatoTipo5(Microsoft.Office.Interop.Excel.Application XcelApp, int semana)
        {
            XcelApp.Cells[5, 2] = supervisor;
            XcelApp.Cells[5, 9] = DateTime.Now.Day + " / " + DateTime.Now.Month + " / " + DateTime.Now.Year;
            XcelApp.Cells[11, 2] = codigo + " - " + lote;
        ...
        public void formatoTipo3(Microsoft.Office.Interop.Excel.Application XcelApp, int semana)
        {
            ...
            XcelApp.Cells[5, 9] = DateTime.Now.Day + " / " + DateTime.Now.Month + " / " + DateTime.Now.Year;
            XcelApp.Cells[10, 2] = actividad;
            XcelApp.Cells[10, 2] = codigo + " - " + lote;
            XcelApp.Cells[10, 5] = area;
            XcelApp.Cells[10, 6] = unidad;
            XcelApp.Cells[10, 8] = estado;
            XcelApp.Cells[10, 12] = nomOrden;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF002*");
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF003*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF004*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF005*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF006*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF007*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF008*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF009*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF010*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF011*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF012*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF013*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF014*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF015*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF016*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF017*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF018*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\", "ADF019*");
                XcelApp.Application.Workbooks.Add(prueba[0]);
                Microsoft.Office.Interop.Excel.Worksheet xlWorkSheet;
                xlWorkSheet = (Microsoft.Office.Interop.Excel.Worksheet)XcelApp.Worksheets.get_Item(1);
                xlWorkSheet.PageSetup.LeftHeader = "&B" + nomOperador + "\n" + NIT;
            ...
            if (data.Rows.Count != 0)
            {
                for (int i = 0; i < data.Rows.Count; i++)
                {
                    ...
                    for (int j = inicio; j < final; j++)
                    {
                        ...
                        {
                            bool isNum = double.TryParse(data.Rows[i].Cells[j].Value.ToString(), out num);
                            if (isNum)
                            {
                                total = total + double.Parse(data.Rows[i].Cells[j].Value.ToString());
                            }
                        }
                    }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            //    agregarLog("Permiso de modificación de asistencia revocado.", usuario);
            //}
            if ((double)(dataGridView8.Rows[0].Cells[dataGridView8.Columns.Count - 1].Value) % 10 == 0)
            {
        ...
        public double crearPromedio(DataGridView data, double castigo)
        {
            ...
            double promedio = 0;
            int cantidad = 0;
            while (!termino || (cantidad < data.Rows.Count - 1))
            {
                ...
                {
                    cantidad++;
                    double promedioTemp = ((((((d1 + d2 - (2 * (castigo)))/400))* ((d1 + d2 - (2 * (castigo)))/400))) * Math.PI) * l;
        ...
        public double crearPromedio(DataGridView data, double castigo, int cant)
        {
            bool termino = false;
            double promedio = 0;
            int cantidad = 0;
            ...
            {
                double d1 = double.Parse(data.Rows[i].Cells[1].Value.ToString());
                double d2 = double.Parse(data.Rows[i].Cells[2].Value.ToString());
                double l = double.Parse(data.Rows[i].Cells[3].Value.ToString());
                double promedioTemp = ((((((d1 + d2 - (2 * (castigo))) / 400)) * ((d1 + d2 - (2 * (castigo))) / 400))) * Math.PI) * l;
                promedio += promedioTemp;
            }
            if (cant != 0)
        ...
        public double PromedioDiametro(DataGridView data, int cant)
        {
            bool termino = false;
            double promedio = 0;
            int cantidad = 0;
        ...
        public double PromedioLargo(DataGridView data, int cant)
        {
            bool termino = false;
            double promedio = 0;
            int cantidad = 0;
        ...
        //        if (cantidad != 75)
        //        {
        //            d1 = double.Parse(data.Rows[cantidad].Cells[1].Value.ToString());
        //            d2 = double.Parse(data.Rows[cantidad].Cells[2].Value.ToString());
        //            l = double.Parse(data.Rows[cantidad].Cells[3].Value.ToString());
        //        }
        //        if ((d1 == 0 && d2 == 0 && l == 0) || (cantidad > (data.Rows.Count - 1)))
        //        {
        //            termino = false;
        //        }
        //        else
        ...
        {
            int cant = 0;
            cant = PromedioCantidad(dataGridView28);
            ...
            double promedio = crearPromedio(dataGridView28, double.Parse(textBox15.Text), cant);
            double promedioD = PromedioDiametro(dataGridView28);
            double promedioL = PromedioLargo(dataGridView28);
            ...
            double prom = (((promedioD - double.Parse(textBox15.Text)) / 200) * ((promedioD - double.Parse(textBox15.Text)) / 200)) * Math.PI * cant;
            MessageBox.Show(prom + "");
            agregarVolumen(Math.Floor(promedioD), promedioL, cant, promedio, especie, trailer, raleo, "ADF012");
            MessageBox.Show("Transferencia de Material a Aserradero FCTH Registrado.\nCon Diametro promedio: " + Math.Floor(promedioD) + "\nLargo Promedio: " + promedioL + "\nCantidad: " + cant + "\nVolumen por Unidad: " + promedio);
        }
        ...
        {
            int cant = 0;
            cant = PromedioCantidad(dataGridView29);
            ...
            double promedio = crearPromedio(dataGridView29, double.Parse(textBox16.Text), cant);
            double promedioD = PromedioDiametro(dataGridView29);
            double promedioL = PromedioLargo(dataGridView29);
            ...
            if (radioButton36.Checked)
                ...
                trailer = "Tractomula";
            double prom = (((promedioD - 2) / 200) * ((promedioD - 2) / 200)) * Math.PI * cant;
            MessageBox.Show(prom + "");
            agregarVolumen(Math.Floor(promedioD), promedioL, cant, promedio, especie, trailer, raleo, "ADF014");
            MessageBox.Show("Transferencia de Material a Aserradero FCTH Registrado.\nCon Diametro promedio: " + Math.Floor(promedioD) + "\nLargo Promedio: " + promedioL + "\nCantidad: " + cant + "\nVolumen por Unidad: " + promedio);
        }
        ...
        public void getOrden(int semana, string orden, string adf, TreeView tree)
        {
            ...
            termino3 = 1;
            comboBox4.SelectedValue = conductor;
        }
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Favor seleccionar un recorrido valido.");
            }
        }
        ...
        public double getControlCosto(int semana, int orden, string adf)
        {
        ...
        public double getMantCosto(int semana, int orden)
        {
        ...
        public void controlCosto(int orden, double costo, string simbolo)
        {
            conn.ConnectionString = connectionString;
            OleDbCommand cmd;
        ...
        {
            Variables.cargar(comboBox13, "SELECT * FROM Insumos WHERE Clase = '" + comboBox15.Text + "'", "Modelo");
            comboBox14.Items.Clear();
            Variables.cargar2(comboBox14, "SELECT Marca FROM Insumos WHERE Clase = '" + comboBox15.Text + "' GROUP BY Marca", "Marca");
        }

        private void comboBox14_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox15.Text.Equals(""))
                Variables.cargar(comboBox13, "SELECT * FROM Insumos WHERE Marca = '" + comboBox14.Text + "'", "Modelo");
            else
                Variables.cargar(comboBox13, "SELECT * FROM Insumos WHERE Marca = '" + comboBox14.Text + "' AND Clase = '" + comboBox15.Text + "'", "Modelo");
        }
        ...
        private void button18_Click_1(object sender, EventArgs e)
        {
            if (comboBox13.SelectedItem != null)
            {
                ...
                dataGridView27.Rows[dataGridView27.Rows.Count - 1].Cells[3].Value = comboBox13.SelectedValue;
            }
        }

        private void dataGridView27_RowsAdded(object sender, DataGridViewRowsAddedEventArgs e)
        {
            if (dataGridView27.Columns.Count > 4)
            {
                dataGridView27.Rows[dataGridView27.Rows.Count - 1].Cells[0].Value = dataGridView27.Rows.Count;
                dataGridView27.Rows[dataGridView27.Rows.Count - 1].Cells[5].Value = 0;
            }
        }

        private void dataGridView27_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView27.Columns.Count > 5)
            {
                if (termino2 == 1)
                {
                    for (int i = 0; i < dataGridView27.Rows.Count; i++)
                    {
                        if (dataGridView27.Rows[i].Cells[3].FormattedValue != null && !dataGridView27.Rows[i].Cells[3].FormattedValue.Equals(""))
                        {
                            dataGridView27.Rows[i].Cells[4].Value = getValor((int)dataGridView27.Rows[i].Cells[3].Value);
                            dataGridView27.Rows[i].Cells[6].Value = double.Parse(dataGridView27.Rows[i].Cells[4].Value.ToString()) * double.Parse(dataGridView27.Rows[i].Cells[5].Value.ToString());
                        }
                    }
                    //Contador(dataGridView14, 5, 17);
                }
        ...
        {
            if (ADF19Existe(OT, "ADF019") == false)
            {
                crearADF19(OT, "ADF019", dataGridView27);
                //agregarADF(semanaFinal, OT, "ADF011");
                controlCosto(Int32.Parse(OT), getControlCosto(0, Int32.Parse(OT), "ADF019"), "+");
                agregarLog("Usuario ha modificado el formato ADF019 en la OT #" + OT, userName);
            }
            else
            {
                controlCosto(Int32.Parse(OT), getControlCosto(0, Int32.Parse(OT), "ADF019"), "-");
                //agregarADF(semanaFinal, OT, "ADF011");
                modificarADF019(OT, "ADF019", dataGridView27);
                //eliminarADF(semanaFinal, OT, "ADF011");
                cant19 = dataGridView27.Rows.Count;
                controlCosto(Int32.Parse(OT), getControlCosto(0, Int32.Parse(OT), "ADF019"), "+");
                agregarLog("Usuario ha modificado el formato ADF019 en la OT #" + OT, userName);
            }
            MessageBox.Show("Control general registrado.");
        }

        private void dataGridView27_CurrentCellDirtyStateChanged(object sender, EventArgs e)
        {
            Variables.dirtyCell(dataGridView27);
        }
        ...
        private void button19_Click_1(object sender, EventArgs e)
        {
            for (int i = 0; i < 300; i++)
            {
                dataGridView28.Rows[i].Cells[1].Value = 0;
                dataGridView28.Rows[i].Cells[2].Value = 0;
                dataGridView28.Rows[i].Cells[3].Value = 0;
            }
        }

        private void button25_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < Int32.Parse(txtCantidad.Text); i++)
            {
                dataGridView28.Rows[i].Cells[3].Value = double.Parse(txtLargo.Text);
            }
        }
        ...
        private void button27_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < 300; i++)
            {
                dataGridView29.Rows[i].Cells[1].Value = 0;
                dataGridView29.Rows[i].Cells[2].Value = 0;
                dataGridView29.Rows[i].Cells[3].Value = 0;
            }
        }

        private void button26_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < Int32.Parse(txtCantidad2.Text); i++)
            {
                dataGridView29.Rows[i].Cells[3].Value = double.Parse(txtLargo2.Text);
            }
        }
