...
namespace Aplicativo
{
    public partial class frmLotes : Form
    {
        ...
        public void modificarArea(int clase)
        {
            ...
            if (conn.State == ConnectionState.Open)
            {
                if (clase == 1)
                {
                    ...
                    cmd.Parameters.Add("@Longitud", OleDbType.VarChar).Value = txtLongProt.Text.Replace('.', ',');
                    cmd.Parameters.Add("@Latitud", OleDbType.VarChar).Value = txtLatProt.Text.Replace('.', ',');
                    cmd.Parameters.Add("@Unidad", OleDbType.VarChar).Value = txtUnidadProt.SelectedValue;
                    cmd.Parameters.Add("@Area", OleDbType.VarChar).Value = txtAreaProt.Text.Replace('.', ',');
                ...
                else
                {
                    ...
                    cmd.Parameters.Add("@Longitud", OleDbType.VarChar).Value = txtLongAgua.Text.Replace('.', ',');
                    cmd.Parameters.Add("@Latitud", OleDbType.VarChar).Value = txtLatAgua.Text.Replace('.', ',');
                    cmd.Parameters.Add("@Unidad", OleDbType.VarChar).Value = txtUnidadAgua.SelectedValue;
                    cmd.Parameters.Add("@Area", OleDbType.VarChar).Value = txtAreaAgua.Text.Replace('.', ',');
        ...
        public void agregarLote() {
            ...
            if (conn.State == ConnectionState.Open)
            {
                ...
                cmd.Parameters.Add("@Longitud", OleDbType.VarChar).Value = txtLong.Text.Replace('.', ',');
                cmd.Parameters.Add("@Latitud", OleDbType.VarChar).Value = txtLat.Text.Replace('.', ',');
                ...
                cmd.Parameters.Add("@areaPlantacion", OleDbType.VarChar).Value = txtAreaPlant.Text.Replace('.', ',');
                cmd.Parameters.Add("@areaEfectiva", OleDbType.VarChar).Value = txtAreaEfe.Text.Replace('.', ',');
                ...
                cmd.Parameters.Add("@semillaOrigen", OleDbType.VarChar).Value = textBox7.SelectedValue;
        ...
        public void agregarCampamento()
        {
            ...
            if (conn.State == ConnectionState.Open)
            {
                ...
                cmd.Parameters.Add("@Longitud", OleDbType.VarChar).Value = Camp4.Text.Replace('.', ',');
                cmd.Parameters.Add("@Latitud", OleDbType.VarChar).Value = Camp5.Text.Replace('.', ',');
        ...
        public void agregarLoteGanadero()
        {
            ...
            if (conn.State == ConnectionState.Open)
            {
                ...
                cmd.Parameters.Add("@Longitud", OleDbType.VarChar).Value = txtLongGan.Text.Replace('.', ',');
                cmd.Parameters.Add("@Latitud", OleDbType.VarChar).Value = txtLatGan.Text.Replace('.', ',');                
                ...
                cmd.Parameters.Add("@Area", OleDbType.VarChar).Value = txtAreaGan.Text.Replace('.', ',');
        ...
        public frmLotes()
        {
            ...
            cargarLotesGanadero();
            cargarCampamento();
            Variables.cargar(txtNumFSC, "SELECT * FROM certificadoFSC", "Certificado");
            txtCif.Text = "No";
            txtFSC.Text = "No";
            txtNumFSC.Text = "0";
            txtCarbono.Text = "No";
                ...
                imprimirLotes(dataGridView5);
	{
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (!textBox7.Text.Equals("N/A"))
            {
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\Semillas", textBox7.Text + "*");
                if (prueba.Length > 0)
                {
