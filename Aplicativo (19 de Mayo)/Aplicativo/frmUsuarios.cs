    ...
    public partial class frmUsuarios : Form
    {
        ...
        public int getTipo(string tipo)
        {
            if (tipo.Equals("Administrador"))
                ...
                return 2;
            else if (tipo.Equals("Almacenista"))
                return 3;
            else if (tipo.Equals("Supervisor de Producción"))
                return 4;
            else
                return 5;
        }
        ...
        public void agregarUsuario()
        {
            ...
            if (conn.State == ConnectionState.Open)
            {
                ...
                cmd.Parameters.Add("@tipo", OleDbType.VarChar).Value = getTipo(comboBox1.Text);
        ...
        public string getTipoCombo(string tipo)
        {
            if (tipo.Equals("1"))
                ...
                return "Supervisor de Cuchillas";
        }
        ...
        private void gridSupervisor_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //else
            //    radioButton2.Checked = true;
            comboBox1.Text = getTipoCombo(gridSupervisor.Rows[gridSupervisor.CurrentCell.RowIndex].Cells[5].Value.ToString());
        }
