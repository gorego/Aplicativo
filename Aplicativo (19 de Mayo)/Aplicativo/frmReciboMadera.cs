...
namespace Aplicativo
{
    public partial class frmReciboMadera : Form
    {
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\Lotes\\" + comboBox1.Text + "\\Registro");
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\Lotes\\" + comboBox1.Text + "\\Registro", "Registro*");
                if (prueba.Length > 0)
                {
