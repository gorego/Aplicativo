...
namespace Aplicativo
{
    public partial class frmHistoricoOrdenes : Form
    {
        ...
        {
            string query = "SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal, (t.Nombres+' '+t.Apellidos) AS Supervisor, h.estadoOrden, h.costoFinal, h.costoJornalFinal, (h.costoFinal+h.costoJornalFinal) AS Expr1, Operador.Operador, area.estadoFSC  FROM (Lotes AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote) INNER JOIN Operador ON h.Operador = Operador.ID ORDER BY h.ID DESC UNION ALL SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal, (t.Nombres+' '+t.Apellidos) AS Supervisor, h.estadoOrden, h.costoFinal, h.costoJornalFinal, (h.costoFinal+h.costoJornalFinal) AS Expr1, Operador.Operador, area.estadoFSC  FROM (LoteGanadero AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote) INNER JOIN Operador ON h.Operador = Operador.ID ORDER BY h.ID DESC UNION ALL SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal, (t.Nombres+' '+t.Apellidos) AS Supervisor, h.estadoOrden, h.costoFinal, h.costoJornalFinal, (h.costoFinal+h.costoJornalFinal) AS Expr1, Operador.Operador, area.estadoFSC  FROM (Areas AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote) INNER JOIN Operador ON h.Operador = Operador.ID ORDER BY h.ID DESC";       
            ...
            dataGridView1.Columns[12].HeaderText = "Lote FSC";
        ...
        {
            string query = "SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal, (t.Nombres+' '+t.Apellidos) AS Supervisor, h.estadoOrden, h.costoFinal, h.costoJornalFinal, (h.costoFinal+h.costoJornalFinal) AS Expr1, Operador.Operador, area.estadoFSC FROM (Lotes AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote) INNER JOIN Operador ON h.Operador = Operador.ID WHERE h.estadoOrden = 'Activa' OR h.estadoOrden = 'Vencida' ORDER BY h.ID DESC UNION ALL SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal, (t.Nombres+' '+t.Apellidos) AS Supervisor, h.estadoOrden, h.costoFinal, h.costoJornalFinal, (h.costoFinal+h.costoJornalFinal) AS Expr1, Operador.Operador, area.estadoFSC  FROM (LoteGanadero AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote) INNER JOIN Operador ON h.Operador = Operador.ID WHERE h.estadoOrden = 'Activa' OR h.estadoOrden = 'Vencida' ORDER BY h.ID DESC UNION ALL SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal, (t.Nombres+' '+t.Apellidos) AS Supervisor, h.estadoOrden, h.costoFinal, h.costoJornalFinal, (h.costoFinal+h.costoJornalFinal) AS Expr1, Operador.Operador, area.estadoFSC  FROM (Areas AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote) INNER JOIN Operador ON h.Operador = Operador.ID WHERE h.estadoOrden = 'Activa' OR h.estadoOrden = 'Vencida' ORDER BY h.ID DESC";       
            ...
            dataGridView2.Columns[12].HeaderText = "Lote FSC";
        ...
        {
            //string query = "SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal, (t.Nombres+' '+t.Apellidos) AS Supervisor, h.estadoOrden, h.costoFinal, h.costoJornalFinal, (h.costoFinal+h.costoJornalFinal) AS Expr1, Operador.Operador FROM (Lotes AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote) INNER JOIN Operador ON h.Operador = Operador.ID WHERE (h.estadoOrden = 'Activa' OR h.estadoOrden = 'Vencida') AND h.Supervisor = " + id + " ORDER BY h.ID DESC UNION ALL SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal, (t.Nombres+' '+t.Apellidos) AS Supervisor, h.estadoOrden, h.costoFinal, h.costoJornalFinal, (h.costoFinal+h.costoJornalFinal) AS Expr1, Operador.Operador FROM (LoteGanadero AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote) INNER JOIN Operador ON h.Operador = Operador.ID WHERE (h.estadoOrden = 'Activa' OR h.estadoOrden = 'Vencida') AND h.Supervisor = " + id + " ORDER BY h.ID DESC UNION ALL SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal, (t.Nombres+' '+t.Apellidos) AS Supervisor, h.estadoOrden, h.costoFinal, h.costoJornalFinal, (h.costoFinal+h.costoJornalFinal) AS Expr1, Operador.Operador FROM (Areas AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote) INNER JOIN Operador ON h.Operador = Operador.ID WHERE (h.estadoOrden = 'Activa' OR h.estadoOrden = 'Vencida') AND h.Supervisor = " + id + " ORDER BY h.ID DESC";      
            string query = "SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal, (t.Nombres + ' ' + t.Apellidos) As Supervisor, h.estadoOrden, area.estadoFSC  FROM Areas AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote WHERE (h.estadoOrden = 'Activa' OR h.estadoOrden = 'Vencida') AND h.Supervisor = " + id + " ORDER BY h.ID desc UNION ALL SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal, (t.Nombres + ' ' + t.Apellidos) As Supervisor, h.estadoOrden, area.estadoFSC  FROM LoteGanadero AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote WHERE (h.estadoOrden = 'Activa' OR h.estadoOrden = 'Vencida') AND h.Supervisor = " + id + " ORDER BY h.ID desc UNION ALL SELECT h.ID, h.OT, a.Actividad, area.Lote, h.fechaInicio, h.fechaFinal,(t.Nombres + ' ' + t.Apellidos) As Supervisor, h.estadoOrden, area.estadoFSC  FROM Lotes AS area INNER JOIN (Actividades AS a INNER JOIN (Trabajadores AS t INNER JOIN historicoOrdenes AS h ON t.ID = h.Supervisor) ON a.ID = h.Actividad) ON area.Codigo = h.Lote WHERE (h.estadoOrden = 'Activa' OR h.estadoOrden = 'Vencida') AND h.Supervisor = " + id + " ORDER BY h.ID desc";
            //Ejecutar el query y llenar el GridView.
            conn.ConnectionString = connectionString;
            OleDbCommand cmd = new OleDbCommand(query, conn);
            DataTable banco = new DataTable();
            ...
            dataGridView2.Columns[5].HeaderText = "Fecha de Finalización";
            dataGridView2.Columns[7].HeaderText = "Estado de la Orden";
            dataGridView2.Columns[8].HeaderText = "Lote FSC";
            dataGridView2.Columns[0].Visible = false;
        }
