...
namespace Aplicativo
{
    public partial class frmTransportador : Form
    {
        ...
        public void subirArchivo(string archivo, TextBox text) 
        {
            ...
            if (!arch.Equals("")) 
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\Transportadores\\" + textBox1.Text + " " + textBox2.Text);
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\Transportadores\\" + textBox1.Text + " " + textBox2.Text, archivo+"*");
                if (prueba.Length > 0)
                {
                ...
                using (FileStream fs = File.Open(arch, FileMode.Open))
                {
                    ...
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\Transportadores\\" + textBox1.Text + " " + textBox2.Text + "\\"+ archivo + ext));
                }
            }
        }
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                if (conn.State == ConnectionState.Open)
                {
                    try
                    {
                        ...
                        //Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\Transportadores\\" + textBox1.Text);
                        //if (Directory.Exists("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\Transportadores\\" + textBox1.Text + " " + textBox2.Text))
                        //{
                        //    Directory.Delete("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\Transportadores\\" + textBox1.Text + " " + textBox2.Text);
                        //}
                        conn.Close();
                    }
                    catch (OleDbException ex)
        ...
        {
            Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\Transportadores\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString());
            string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\Transportadores\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString(), archivo+"*");
            if (prueba.Length > 0)
            {
                if (File.Exists(prueba[0]))
                {
