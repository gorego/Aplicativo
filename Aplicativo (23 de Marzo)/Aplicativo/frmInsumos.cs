...
namespace Aplicativo
{
    public partial class frmInsumos : Form
    {
        ...
        {
            string query = "SELECT MAX(Codigo) FROM Insumos";
            //Ejecutar el query y llenar el GridView.
            conn.ConnectionString = connectionString;
            OleDbCommand cmd = new OleDbCommand(query, conn);
            cmd.Connection = conn;
        ...
        {
            string query = "SELECT ID,(Tipo + ' / ' + Marca + ' / ' + Modelo + ' / ' + Placa) As Maquinaria FROM Maquinarias";
        ...
        {
            conn.ConnectionString = connectionString;
            OleDbCommand cmd = new OleDbCommand("INSERT INTO Insumos(Codigo,Clase,Marca,Modelo,Serial,Descripcion,Proveedor,Unidad_Medida,Costo_Unitario,Cantidad_Stock,Stock_Minimo,Ubicacion,Peso,Tipo,Ancho,Grueso,Largo) VALUES (@Codigo,@Clase,@Marca,@Modelo,@Serial,@Descripcion,@Proveedor,@Unidad_Medida,@Costo_Unitario,@Cantidad_Stock,@Stock_Minimo,@Ubicacion,@Peso,@Tipo,@Ancho,@Grueso,@Largo)");
            cmd.Connection = conn;
            conn.Open();
        ...
        {            
            ...
            txtAncho.Text = dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[15].Value.ToString();
            txtGrueso.Text = dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[16].Value.ToString();
            txtLargo.Text = dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[17].Value.ToString();
        ...
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtTipo.Text = dataGridView2.Rows[dataGridView2.CurrentCell.RowIndex].Cells[14].Value.ToString();
            txtAncho.Text = dataGridView2.Rows[dataGridView2.CurrentCell.RowIndex].Cells[15].Value.ToString();
            txtGrueso.Text = dataGridView2.Rows[dataGridView2.CurrentCell.RowIndex].Cells[16].Value.ToString();
            txtLargo.Text = dataGridView2.Rows[dataGridView2.CurrentCell.RowIndex].Cells[17].Value.ToString();
