    ...
    public partial class frmCargosLaborales : Form
    {
        ...
        public void CalculoSalario()
        {
            ...
            if (txtRiesgo.Text.Trim().Equals(""))
                ...
                riesgo = txtRiesgo.Text.Replace(".",string.Empty).Replace("%",string.Empty).Replace(",",string.Empty);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.CurrentCell.ColumnIndex == 2) {
                ...
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\" + this.Text + "\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString());
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\" + this.Text + "\\" + dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString(), "Descripcion*");
                if (prueba.Length > 0)
                {
        ...
        public void subirArchivo(string cargo) {
            ...
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\" + this.Text + "\\" + cargo);
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\" + this.Text + "\\" + cargo, "Descripcion*");
                if (prueba.Length > 0)
                {
                    if (File.Exists(prueba[0]))
                    {
                ...
                using (FileStream fs = File.Open(Descripcion, FileMode.Open))
                {
                    ...
                    fs.CopyTo(File.Create("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Anexos\\" + this.Text + "\\" + cargo + "\\Descripcion" + ext));
                }
            }
        }
