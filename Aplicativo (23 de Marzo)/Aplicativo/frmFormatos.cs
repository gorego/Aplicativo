...
namespace Aplicativo
{
    public partial class frmFormatos : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                Directory.CreateDirectory("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos");
                string[] prueba = Directory.GetFiles("C:\\Users\\" + Environment.UserName + "\\Dropbox\\Aplicativo\\Formatos\\",  dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString()+"*");
                if (prueba.Length > 0)
                {
                    if (File.Exists(prueba[0]))
                    {
